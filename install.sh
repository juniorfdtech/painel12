...
#echo ""
echo -e "\n\033[1;36mVERIFICANDO... \033[0m" ; rm $_Ink/list > /dev/null 2>&1; wget -P $_Ink https://raw.githubusercontent.com/script90/32/master/scripts/list > /dev/null 2>&1; verif_key
echo -e "\n\033[1;32mTUDO CERTO!\033[1;32m"
sleep 1s
echo ""
[[ -f "$HOME/usuarios.db" ]] && {
clear
...
echo ""
echo ""
echo -e "          \033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mATUALIZANDO O SISTEMA \033[1;33m[\033[1;31m!\033[1;33m]\033[0m"
echo ""
